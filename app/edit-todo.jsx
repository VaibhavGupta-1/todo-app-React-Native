...
export default function EditTodoScreen() {
  ...
  const loadData = async () => {
    ...
    try {
      const [allGroups, allTodos] = await Promise.all([
        localDB.getGroups(user.id),
        localDB.getTodos(user.id),
      ]);
      ...
      if (todo) {
        ...
        setSelectedGroupId(todo.group_id);
      } else {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await syncManager.updateTodo(updatedTodo);
      router.back();
    } catch (error) {
